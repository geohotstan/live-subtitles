# Subtitles (Rust, macOS Sequoia+ MVP)

This is the Rust implementation. The Swift implementation lives in `../subtitles-swift`.
...
- Default output language is **English** (`--output-language english`). Available: `english`, `chinese`, `bilingual` (Chinese + English).
